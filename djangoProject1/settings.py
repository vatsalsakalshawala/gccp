...
ROOT_URLCONF = 'djangoProject1.urls'  # Replace 'djangoProject1' with your project name
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'vatsal.sakalshawala@gmail.com'
EMAIL_HOST_PASSWORD = 'zaqtrhdqlctugfhp'
